  ...
  const drawer = (
    <Box sx={{ 
      ...
      <List sx={{ width: '100%' }}>
        ...
        <Tooltip title="Post-Disaster Updates" placement="right">
          <ListItem disablePadding>
            <ListItemButton 
              component="a" 
              href="/post-disaster" 
              sx={{ justifyContent: 'center', py: 2 }}
            >
              <ListItemIcon sx={{ minWidth: 0 }}><PostDisasterIcon /></ListItemIcon>
              <ListItemText primary="Post-Disaster Updates" sx={{ display: 'none' }} />
            </ListItemButton>
          </ListItem>
        </Tooltip>
