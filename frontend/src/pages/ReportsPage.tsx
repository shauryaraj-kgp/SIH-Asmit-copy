...
export default function ReportsPage() {
  ...
  const handleDisasterChange = (event: SelectChangeEvent<number>) => {
  ...
  const getCurrentDisasterQuery = (): DisasterQuery => {
            ...
            {activeStep === 1 && (
              <Box>
                ...
                <TextField
                  ...
                  variant="outlined"
                  sx={{ mt: 2, mb: 4 }}
                  defaultValue={`${reportType.charAt(0).toUpperCase() + reportType.slice(1)} Report - ${
                    selectedDisasterIndex === DISASTER_OPTIONS.length - 1 
                      ? customDisasterName 
